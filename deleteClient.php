...
if ($conn->query($sql) === TRUE) {
    echo "Nominees deleted successfully";   '</br>';
} else {
    echo "Error deleting Nominees: " . $conn->error;   '</br>';
}
...
if ($conn->query($sql) === TRUE) {
    echo "Payments deleted successfully";   '</br>';
} else {
    echo "Error deleting Payments: " . $conn->error;   '</br>';
}
