...
<?php
		...
		if($agent_id== $username || "" == $username){
			echo "<a href='editClient.php?client_id=".$c_id. "'>Edit Client</a>";
		}else {
			echo "<a class=\"dis\" href='editClient.php?client_id=".$c_id. "'>Edit Client</a>";
		}
...
echo '</div>';
	...
	echo "<br>\n";
	echo "<br>\n";
	echo '<b>Policy Information</b>';	            //   PRINTS AGENTS INFO
	...
	while($row = $result->fetch_assoc()) {
		...
		if($row["agent_id"]== $username || "" == $username){
